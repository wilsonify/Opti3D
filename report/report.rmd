...
We then model tensile strength from a csv file obtain from Kaggle Dataset. [@okudan20183dprinterdataset] After applying that model to our metadata, we model filament usage as a function of similar inputs.
